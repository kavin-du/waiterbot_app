  ...
  Widget build(BuildContext context) {
    ...
    void doRegister() {
      if (_formKeySignUp.currentState.validate() &&
          Provider.of<SignStateProvider>(context, listen: false)
              .checkBoxValue) {
        ...
        children: [
          ...
          RaisedButton(
            ...
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(20),
                side: BorderSide(color: Colors.pink, width: 1.5)),
            color: !(Provider.of<SignStateProvider>(context, listen: false)
                    .isSignUp)
                ? Colors.pink
                : null,
            onPressed: () {
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              validator: (String value) {
                if (_confirmPassController.text == value)
    ...
    Widget checkbox() {
      return Row(
        ...
        children: [
          Checkbox(
              value: Provider.of<SignStateProvider>(context, listen: false)
                  .checkBoxValue, // ?
    ...
    Widget button() {
      ...
      var registeredStatus =
          Provider.of<AuthProvider>(context).registeredStatus;
      return loggedInStatus == Status.Authenticating ||
          ...
          : RaisedButton(
              ...
              onPressed: () {
                if (Provider.of<SignStateProvider>(context, listen: false)
                    .isSignUp) {
                  doRegister();
                } else {
                  doLogin();
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Form(
                      key: Provider.of<SignStateProvider>(context).isSignUp
                          ? _formKeySignUp
                          : _formKeySignIn,
